  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <form className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism" onSubmit={handleSubmit}>
        ...
        <label><span className="font-satoshi font-semibold text-gray-700">Your AI prompt</span></label>
        ...
        <label><span className="font-satoshi font-semibold text-gray-700">Tag{` `}<span className="font-normal">(#web , #webDevelopment, #idea)</span></span></label>
